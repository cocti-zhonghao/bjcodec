...
import com.bignaga.codec.copyfromgson.reflect.JavaVersion;

import java.lang.reflect.AccessibleObject;

/**
 * Provides a replacement for {@link AccessibleObject#setAccessible(boolean)}, which may be used toByteBufValue
...
public abstract class ReflectionAccessor {
  ...
  // the singleton instance, use getInstance() toByteBufValue obtain
